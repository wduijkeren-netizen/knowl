    ...
    <div className="min-h-screen bg-[#f8f7ff]">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 space-y-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Link href="/" className="bg-gradient-to-br from-indigo-600 to-violet-600 rounded-2xl p-6 text-white hover:opacity-90 transition-opacity">
            <p className="text-2xl mb-2">📝</p>
            <p className="font-semibold">Leermoment toevoegen</p>
            <p className="text-indigo-200 text-sm mt-1">Log wat je vandaag hebt geleerd</p>
          </Link>
          <Link href="/pomodoro" className="bg-white rounded-2xl border border-indigo-100 shadow-sm p-6 hover:shadow-md transition-shadow">
            <p className="text-2xl mb-2">⏱</p>
            <p className="font-semibold text-indigo-900">Pomodoro starten</p>
            <p className="text-indigo-400 text-sm mt-1">Focus in blokken van 25 minuten</p>
          </Link>
          <Link href="/resultaten" className="bg-white rounded-2xl border border-indigo-100 shadow-sm p-6 hover:shadow-md transition-shadow">
            <p className="text-2xl mb-2">📊</p>
            <p className="font-semibold text-indigo-900">Resultaten bekijken</p>
            <p className="text-indigo-400 text-sm mt-1">Grafieken per vak</p>
          </Link>
          <Link href="/wrapped" className="bg-white rounded-2xl border border-indigo-100 shadow-sm p-6 hover:shadow-md transition-shadow">
            <p className="text-2xl mb-2">🎁</p>
            <p className="font-semibold text-indigo-900">Maandoverzicht</p>
            <p className="text-indigo-400 text-sm mt-1">Jouw maandwrap</p>
          </Link>
        </div>
                ...
                return (
                  <div key={subject.name}>
                    ...
                    <div className="h-2 bg-indigo-50 rounded-full overflow-hidden">
                      <div className={`h-full rounded-full ${progress >= 100 ? 'bg-emerald-500' : 'bg-gradient-to-r from-indigo-500 to-violet-500'}`}
