...
export default function Nav() {
  ...
  const overzichtLinks: DropdownItem[] = [
    ...
    { href: '/notities', label: tr.nav.notities ?? 'Notities' },
  ...
  const lerenLinks: DropdownItem[] = [
    ...
    { href: '/pomodoro/groep', label: tr.nav.group ?? 'Groepsstudie' },
  ...
  const allMobileLinks = isLoggedIn ? [
    ...
    { href: '/notities', label: tr.nav.notities ?? 'Notities', group: 'overzicht' },
    ...
    { href: '/pomodoro/groep', label: tr.nav.group ?? 'Groepsstudie', group: 'leren' },
