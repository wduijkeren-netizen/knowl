...
const t = {
  ...
  en: {
    nav: { moments: 'Learning moments', results: 'Results', subjects: 'Subjects', logout: 'Log out', more: 'More', monthly: 'Monthly overview', profile: 'Profile', home: 'Home', loginBtn: 'Log in', timer: 'Timer', week: 'Weekly overview', agenda: 'Agenda', 'flashcards': 'Flashcards', 'woordweb': 'Word map', 'feedback': 'Feedback', 'loginLink': 'Log in', grades: 'Grade calculator', overview: 'Overview', learn: 'Learn', members: 'Members', you: '(you)', schedule: 'Schedule', friends: 'Friends' },
    dashboard: {
  ...
  es: {
    nav: { moments: 'Momentos de aprendizaje', results: 'Resultados', subjects: 'Asignaturas', logout: 'Cerrar sesión', more: 'Más', monthly: 'Resumen mensual', profile: 'Perfil', home: 'Inicio', loginBtn: 'Iniciar sesión', timer: 'Temporizador', week: 'Resumen semanal', agenda: 'Agenda', 'flashcards': 'Flashcards', 'woordweb': 'Mapa mental', 'feedback': 'Comentarios', 'loginLink': 'Iniciar sesión', grades: 'Calculadora de notas', overview: 'Resumen', learn: 'Aprender', members: 'Miembros', you: '(tú)', schedule: 'Horario', friends: 'Amigos' },
    dashboard: {
  ...
  pt: {
    nav: { moments: 'Momentos de aprendizado', results: 'Resultados', subjects: 'Disciplinas', logout: 'Sair', more: 'Mais', monthly: 'Resumo mensal', profile: 'Perfil', home: 'Início', loginBtn: 'Entrar', timer: 'Temporizador', week: 'Resumo semanal', agenda: 'Agenda', 'flashcards': 'Flashcards', 'woordweb': 'Mapa mental', 'feedback': 'Feedback', 'loginLink': 'Entrar', grades: 'Calculadora de notas', overview: 'Visão geral', learn: 'Aprender', members: 'Membros', you: '(você)', schedule: 'Horário', friends: 'Amigos' },
    dashboard: {
