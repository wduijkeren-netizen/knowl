...
const t = {
  nl: {
    ...
    wrapped: {
      ...
      timesLogged: 'x gelogd', min: 'min', logged: 'gelogd', weekdays: ['zondag','maandag','dinsdag','woensdag','donderdag','vrijdag','zaterdag'], exportPrint: 'Afdrukken als PDF',
    },
    pomodoro: {
    ...
    notities: { title: 'Notities', subtitle: 'Schrijf samenvattingen en aantekeningen', new: '+ Nieuwe notitie', noNotes: 'Nog geen notities.', noNotesSub: 'Maak een nieuwe notitie aan.', untitled: 'Naamloze notitie', placeholder: 'Begin met typen...\n\n# Gebruik # voor een koptekst\n- Gebruik - voor een lijst\n**Gebruik ** voor vet**', save: 'Opslaan', saved: 'Opgeslagen', saving: 'Opslaan...', deleteNote: 'Verwijderen', searchPlaceholder: 'Notities zoeken...', preview: 'Voorbeeld', edit: 'Bewerken', subjectLabel: 'Vak', wordCount: 'woorden', autoSaved: 'Automatisch opgeslagen', shortcuts: 'Snelkoppelingen', shortcutBold: 'Ctrl+B → vet', shortcutItalic: 'Ctrl+I → cursief', shortcutH1: '# + spatie → koptekst', shortcutList: '- + spatie → lijst', noSubject: 'Geen vak', lastEdited: 'Bewerkt' },
    friends: { title: 'Vrienden', subtitle: 'Zie hoe jouw vrienden studeren', follow: 'Volgen', unfollow: 'Ontvolgen', noFriends: 'Je volgt nog niemand.', noFriendsSub: 'Zoek iemand op via gebruikersnaam.', searchPlaceholder: 'Zoek op gebruikersnaam...', search: 'Zoeken', streakLabel: 'streak', hoursMonth: 'uur deze maand', notFound: 'Geen gebruiker gevonden', following: 'Je volgt', setUsername: 'Gebruikersnaam instellen', usernamePlaceholder: 'jouwgebruikersnaam', saveUsername: 'Opslaan', usernameNote: 'Vrienden vinden je via deze naam.', makePublic: 'Profiel openbaar maken', makePublicSub: 'Vrienden kunnen dan jouw streak en studieuren zien.', isPublic: 'Profiel is openbaar', isPrivate: 'Profiel is privé', saved: 'Opgeslagen!', momentsMonth: 'momenten deze maand' },
  ...
  en: {
    ...
    wrapped: {
      ...
      timesLogged: 'x logged', min: 'min', logged: 'logged', weekdays: ['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'], exportPrint: 'Print as PDF',
    },
    pomodoro: {
    ...
    notities: { title: 'Notes', subtitle: 'Write summaries and study notes', new: '+ New note', noNotes: 'No notes yet.', noNotesSub: 'Create a new note.', untitled: 'Untitled note', placeholder: 'Start typing...\n\n# Use # for a heading\n- Use - for a list\n**Use ** for bold**', save: 'Save', saved: 'Saved', saving: 'Saving...', deleteNote: 'Delete', searchPlaceholder: 'Search notes...', preview: 'Preview', edit: 'Edit', subjectLabel: 'Subject', wordCount: 'words', autoSaved: 'Auto saved', shortcuts: 'Shortcuts', shortcutBold: 'Ctrl+B → bold', shortcutItalic: 'Ctrl+I → italic', shortcutH1: '# + space → heading', shortcutList: '- + space → list', noSubject: 'No subject', lastEdited: 'Edited' },
    friends: { title: 'Friends', subtitle: 'See how your friends are studying', follow: 'Follow', unfollow: 'Unfollow', noFriends: "You're not following anyone yet.", noFriendsSub: 'Search for someone by username.', searchPlaceholder: 'Search by username...', search: 'Search', streakLabel: 'streak', hoursMonth: 'hours this month', notFound: 'No user found', following: 'Following', setUsername: 'Set username', usernamePlaceholder: 'yourusername', saveUsername: 'Save', usernameNote: 'Friends can find you by this name.', makePublic: 'Make profile public', makePublicSub: 'Friends can then see your streak and study hours.', isPublic: 'Profile is public', isPrivate: 'Profile is private', saved: 'Saved!', momentsMonth: 'moments this month' },
  ...
  es: {
    ...
    wrapped: {
      ...
      timesLogged: 'x registrado', min: 'min', logged: 'registrados', weekdays: ['domingo','lunes','martes','miércoles','jueves','viernes','sábado'], exportPrint: 'Imprimir como PDF',
    },
    pomodoro: {
    ...
    notities: { title: 'Notas', subtitle: 'Escribe resúmenes y apuntes', new: '+ Nueva nota', noNotes: 'Aún no hay notas.', noNotesSub: 'Crea una nueva nota.', untitled: 'Nota sin título', placeholder: 'Empieza a escribir...', save: 'Guardar', saved: 'Guardado', saving: 'Guardando...', deleteNote: 'Eliminar', searchPlaceholder: 'Buscar notas...', preview: 'Vista previa', edit: 'Editar', subjectLabel: 'Asignatura', wordCount: 'palabras', autoSaved: 'Guardado automáticamente', shortcuts: 'Atajos', shortcutBold: 'Ctrl+B → negrita', shortcutItalic: 'Ctrl+I → cursiva', shortcutH1: '# + espacio → título', shortcutList: '- + espacio → lista', noSubject: 'Sin asignatura', lastEdited: 'Editado' },
    friends: { title: 'Amigos', subtitle: 'Mira cómo estudian tus amigos', follow: 'Seguir', unfollow: 'Dejar de seguir', noFriends: 'No sigues a nadie todavía.', noFriendsSub: 'Busca a alguien por nombre de usuario.', searchPlaceholder: 'Buscar por nombre de usuario...', search: 'Buscar', streakLabel: 'racha', hoursMonth: 'horas este mes', notFound: 'No se encontró ningún usuario', following: 'Siguiendo', setUsername: 'Establecer nombre de usuario', usernamePlaceholder: 'tunombreusuario', saveUsername: 'Guardar', usernameNote: 'Los amigos pueden encontrarte por este nombre.', makePublic: 'Hacer perfil público', makePublicSub: 'Los amigos podrán ver tu racha y horas de estudio.', isPublic: 'El perfil es público', isPrivate: 'El perfil es privado', saved: '¡Guardado!', momentsMonth: 'momentos este mes' },
  ...
  pt: {
    ...
    wrapped: {
      ...
      timesLogged: 'x registrado', min: 'min', logged: 'registrados', weekdays: ['domingo','segunda','terça','quarta','quinta','sexta','sábado'], exportPrint: 'Imprimir como PDF',
    },
    pomodoro: {
    ...
    notities: { title: 'Notas', subtitle: 'Escreva resumos e anotações', new: '+ Nova nota', noNotes: 'Ainda sem notas.', noNotesSub: 'Crie uma nova nota.', untitled: 'Nota sem título', placeholder: 'Comece a escrever...', save: 'Salvar', saved: 'Salvo', saving: 'Salvando...', deleteNote: 'Excluir', searchPlaceholder: 'Pesquisar notas...', preview: 'Visualizar', edit: 'Editar', subjectLabel: 'Disciplina', wordCount: 'palavras', autoSaved: 'Salvo automaticamente', shortcuts: 'Atalhos', shortcutBold: 'Ctrl+B → negrito', shortcutItalic: 'Ctrl+I → itálico', shortcutH1: '# + espaço → título', shortcutList: '- + espaço → lista', noSubject: 'Sem disciplina', lastEdited: 'Editado' },
    friends: { title: 'Amigos', subtitle: 'Veja como seus amigos estão estudando', follow: 'Seguir', unfollow: 'Deixar de seguir', noFriends: 'Você ainda não segue ninguém.', noFriendsSub: 'Pesquise alguém pelo nome de usuário.', searchPlaceholder: 'Pesquisar por nome de usuário...', search: 'Pesquisar', streakLabel: 'sequência', hoursMonth: 'horas este mês', notFound: 'Nenhum usuário encontrado', following: 'Seguindo', setUsername: 'Definir nome de usuário', usernamePlaceholder: 'seunomeusuario', saveUsername: 'Salvar', usernameNote: 'Amigos podem te encontrar por este nome.', makePublic: 'Tornar perfil público', makePublicSub: 'Amigos poderão ver sua sequência e horas de estudo.', isPublic: 'Perfil é público', isPrivate: 'Perfil é privado', saved: 'Salvo!', momentsMonth: 'momentos este mês' },
  ...
  fr: {
    ...
    wrapped: {
      ...
      timesLogged: 'x enregistré', min: 'min', logged: 'enregistrés', weekdays: ['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi'], exportPrint: 'Imprimer en PDF',
    },
    pomodoro: {
    ...
    notities: { title: 'Notes', subtitle: 'Rédigez des résumés et des notes de cours', new: '+ Nouvelle note', noNotes: 'Pas encore de notes.', noNotesSub: 'Créez une nouvelle note.', untitled: 'Note sans titre', placeholder: 'Commencez à écrire...', save: 'Enregistrer', saved: 'Enregistré', saving: 'Enregistrement...', deleteNote: 'Supprimer', searchPlaceholder: 'Rechercher des notes...', preview: 'Aperçu', edit: 'Modifier', subjectLabel: 'Matière', wordCount: 'mots', autoSaved: 'Sauvegarde automatique', shortcuts: 'Raccourcis', shortcutBold: 'Ctrl+B → gras', shortcutItalic: 'Ctrl+I → italique', shortcutH1: '# + espace → titre', shortcutList: '- + espace → liste', noSubject: 'Sans matière', lastEdited: 'Modifié' },
    friends: { title: 'Amis', subtitle: 'Voyez comment étudient vos amis', follow: 'Suivre', unfollow: 'Ne plus suivre', noFriends: "Vous ne suivez encore personne.", noFriendsSub: "Recherchez quelqu'un par nom d'utilisateur.", searchPlaceholder: "Rechercher par nom d'utilisateur...", search: 'Rechercher', streakLabel: 'série', hoursMonth: 'heures ce mois', notFound: 'Aucun utilisateur trouvé', following: 'Vous suivez', setUsername: "Définir un nom d'utilisateur", usernamePlaceholder: 'votrenom', saveUsername: 'Enregistrer', usernameNote: "Les amis peuvent vous trouver par ce nom.", makePublic: 'Rendre le profil public', makePublicSub: "Les amis pourront voir votre série et vos heures d'étude.", isPublic: 'Le profil est public', isPrivate: 'Le profil est privé', saved: 'Enregistré!', momentsMonth: 'moments ce mois' },
  ...
  de: {
    ...
    wrapped: {
      ...
      timesLogged: 'x eingetragen', min: 'Min', logged: 'eingetragen', weekdays: ['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag'], exportPrint: 'Als PDF drucken',
    },
    pomodoro: {
    ...
    notities: { title: 'Notizen', subtitle: 'Schreibe Zusammenfassungen und Notizen', new: '+ Neue Notiz', noNotes: 'Noch keine Notizen.', noNotesSub: 'Erstelle eine neue Notiz.', untitled: 'Namenlose Notiz', placeholder: 'Tippe hier...', save: 'Speichern', saved: 'Gespeichert', saving: 'Speichern...', deleteNote: 'Löschen', searchPlaceholder: 'Notizen suchen...', preview: 'Vorschau', edit: 'Bearbeiten', subjectLabel: 'Fach', wordCount: 'Wörter', autoSaved: 'Automatisch gespeichert', shortcuts: 'Tastenkürzel', shortcutBold: 'Ctrl+B → fett', shortcutItalic: 'Ctrl+I → kursiv', shortcutH1: '# + Leerzeichen → Überschrift', shortcutList: '- + Leerzeichen → Liste', noSubject: 'Kein Fach', lastEdited: 'Bearbeitet' },
    friends: { title: 'Freunde', subtitle: 'Sieh wie deine Freunde lernen', follow: 'Folgen', unfollow: 'Entfolgen', noFriends: 'Du folgst noch niemandem.', noFriendsSub: 'Suche jemanden nach Benutzername.', searchPlaceholder: 'Nach Benutzername suchen...', search: 'Suchen', streakLabel: 'Streak', hoursMonth: 'Stunden diesen Monat', notFound: 'Kein Benutzer gefunden', following: 'Du folgst', setUsername: 'Benutzername festlegen', usernamePlaceholder: 'deinbenutzername', saveUsername: 'Speichern', usernameNote: 'Freunde finden dich über diesen Namen.', makePublic: 'Profil öffentlich machen', makePublicSub: 'Freunde können dann deinen Streak und Lernstunden sehen.', isPublic: 'Profil ist öffentlich', isPrivate: 'Profil ist privat', saved: 'Gespeichert!', momentsMonth: 'Momente diesen Monat' },
  ...
  da: {
    ...
    wrapped: {
      ...
      timesLogged: 'x logget', min: 'min', logged: 'logget', weekdays: ['søndag','mandag','tirsdag','onsdag','torsdag','fredag','lørdag'], exportPrint: 'Udskriv som PDF',
    },
    pomodoro: {
    ...
    notities: { title: 'Notater', subtitle: 'Skriv resuméer og studienotater', new: '+ Ny note', noNotes: 'Ingen noter endnu.', noNotesSub: 'Opret en ny note.', untitled: 'Unavngivet note', placeholder: 'Begynd at skrive...', save: 'Gem', saved: 'Gemt', saving: 'Gemmer...', deleteNote: 'Slet', searchPlaceholder: 'Søg noter...', preview: 'Forhåndsvisning', edit: 'Rediger', subjectLabel: 'Fag', wordCount: 'ord', autoSaved: 'Automatisk gemt', shortcuts: 'Genveje', shortcutBold: 'Ctrl+B → fed', shortcutItalic: 'Ctrl+I → kursiv', shortcutH1: '# + mellemrum → overskrift', shortcutList: '- + mellemrum → liste', noSubject: 'Intet fag', lastEdited: 'Redigeret' },
    friends: { title: 'Venner', subtitle: 'Se hvordan dine venner studerer', follow: 'Følg', unfollow: 'Holdt op med at følge', noFriends: 'Du følger ingen endnu.', noFriendsSub: 'Søg efter nogen via brugernavn.', searchPlaceholder: 'Søg efter brugernavn...', search: 'Søg', streakLabel: 'streak', hoursMonth: 'timer denne måned', notFound: 'Ingen bruger fundet', following: 'Du følger', setUsername: 'Indstil brugernavn', usernamePlaceholder: 'ditbrugernavn', saveUsername: 'Gem', usernameNote: 'Venner kan finde dig via dette navn.', makePublic: 'Gør profil offentlig', makePublicSub: 'Venner kan derefter se din streak og studietimer.', isPublic: 'Profil er offentlig', isPrivate: 'Profil er privat', saved: 'Gemt!', momentsMonth: 'øjeblikke denne måned' },
  ...
  sv: {
    ...
    wrapped: {
      ...
      timesLogged: 'x loggat', min: 'min', logged: 'loggade', weekdays: ['söndag','måndag','tisdag','onsdag','torsdag','fredag','lördag'], exportPrint: 'Skriv ut som PDF',
    },
    pomodoro: {
    ...
    notities: { title: 'Anteckningar', subtitle: 'Skriv sammanfattningar och studieanteckningar', new: '+ Ny anteckning', noNotes: 'Inga anteckningar ännu.', noNotesSub: 'Skapa en ny anteckning.', untitled: 'Namnlös anteckning', placeholder: 'Börja skriva...', save: 'Spara', saved: 'Sparad', saving: 'Sparar...', deleteNote: 'Radera', searchPlaceholder: 'Sök anteckningar...', preview: 'Förhandsvisning', edit: 'Redigera', subjectLabel: 'Ämne', wordCount: 'ord', autoSaved: 'Automatiskt sparad', shortcuts: 'Genvägar', shortcutBold: 'Ctrl+B → fetstil', shortcutItalic: 'Ctrl+I → kursiv', shortcutH1: '# + mellanslag → rubrik', shortcutList: '- + mellanslag → lista', noSubject: 'Inget ämne', lastEdited: 'Redigerad' },
    friends: { title: 'Vänner', subtitle: 'Se hur dina vänner studerar', follow: 'Följ', unfollow: 'Sluta följa', noFriends: 'Du följer ingen ännu.', noFriendsSub: 'Sök efter någon via användarnamn.', searchPlaceholder: 'Sök efter användarnamn...', search: 'Sök', streakLabel: 'streak', hoursMonth: 'timmar denna månad', notFound: 'Ingen användare hittades', following: 'Du följer', setUsername: 'Ange användarnamn', usernamePlaceholder: 'dittanvändarnamn', saveUsername: 'Spara', usernameNote: 'Vänner kan hitta dig via det här namnet.', makePublic: 'Gör profil offentlig', makePublicSub: 'Vänner kan då se din streak och studietimmar.', isPublic: 'Profil är offentlig', isPrivate: 'Profil är privat', saved: 'Sparad!', momentsMonth: 'stunder denna månad' },
  ...
  no: {
    ...
    wrapped: {
      ...
      timesLogged: 'x logget', min: 'min', logged: 'logget', weekdays: ['søndag','mandag','tirsdag','onsdag','torsdag','fredag','lørdag'], exportPrint: 'Skriv ut som PDF',
    },
    pomodoro: {
    ...
    notities: { title: 'Notater', subtitle: 'Skriv sammendrag og studienotater', new: '+ Ny notat', noNotes: 'Ingen notater ennå.', noNotesSub: 'Opprett et nytt notat.', untitled: 'Uten navn', placeholder: 'Begynn å skrive...', save: 'Lagre', saved: 'Lagret', saving: 'Lagrer...', deleteNote: 'Slett', searchPlaceholder: 'Søk notater...', preview: 'Forhåndsvisning', edit: 'Rediger', subjectLabel: 'Fag', wordCount: 'ord', autoSaved: 'Automatisk lagret', shortcuts: 'Snarveier', shortcutBold: 'Ctrl+B → fet', shortcutItalic: 'Ctrl+I → kursiv', shortcutH1: '# + mellomrom → overskrift', shortcutList: '- + mellomrom → liste', noSubject: 'Intet fag', lastEdited: 'Redigert' },
    friends: { title: 'Venner', subtitle: 'Se hvordan vennene dine studerer', follow: 'Følg', unfollow: 'Slutt å følge', noFriends: 'Du følger ingen ennå.', noFriendsSub: 'Søk etter noen via brukernavn.', searchPlaceholder: 'Søk etter brukernavn...', search: 'Søk', streakLabel: 'streak', hoursMonth: 'timer denne måneden', notFound: 'Ingen bruker funnet', following: 'Du følger', setUsername: 'Angi brukernavn', usernamePlaceholder: 'dittbrukernavn', saveUsername: 'Lagre', usernameNote: 'Venner kan finne deg via dette navnet.', makePublic: 'Gjør profil offentlig', makePublicSub: 'Venner kan da se din streak og studietimer.', isPublic: 'Profil er offentlig', isPrivate: 'Profil er privat', saved: 'Lagret!', momentsMonth: 'øyeblikk denne måneden' },
