...
const t = {
  nl: {
    ...
    landing: {
      badge: 'Tentamen over 3 weken? Start nu — je eerste leermoment in 30 seconden opgeslagen.',
      ...
      proof: 'Gratis te gebruiken · Geen account nodig · Data bewaard na aanmelden',
      ...
      aboutP1: 'Knowl is ontstaan uit een simpel probleem: je werkt hard, maar weet aan het einde van de week niet meer wat je eigenlijk hebt geleerd.',
      aboutP2: 'Knowl geeft je inzicht — niet meer, niet minder. Geen abonnement, geen reclame.',
      ...
      ctaTitle: 'Zet je eerste leermoment neer in 30 seconden.',
      ctaSub: 'Geen account nodig om te starten. Je verliest niets als je het probeert.',
